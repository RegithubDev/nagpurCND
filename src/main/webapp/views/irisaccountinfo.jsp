...
<!-- BEGIN: Main Menu-->
  ...
  <div class="col-12">
    ...
    <!-- profile -->
    <div class="card p-2">
      <div class="/iris/resources/ border-bottom">
          ...
          <div class="row">
           ...
           <div class="col-md-12 col-12 text-center mt-2">
               <button type="submit" class="btn btn-primary waves-effect waves-float waves-light" name="submit">Submit</button>
                <a href="/iris/home" class="btn btn-dark waves-effect waves-float waves-light"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevrons-left"><polyline points="11 17 6 12 11 7"></polyline><polyline points="18 17 13 12 18 7"></polyline></svg>Back</a>
         </div>
          </div>
        </form>
        <!--/ form -->
    ...
    <script>
      $(window).on('load',  function(){
       ...
       $('#accountEmail').hover(
        ...
        function(){
            $(this).removeClass('disabled-cursor');
        }
    );
    </script>
  </body>
...
<!-- Mirrored from pixinvent.com/demo/vuexy-html-bootstrap-admin-template/html/ltr/vertical-menu-template/page-account-settings-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 Aug 2022 05:40:50 GMT -->
</html>