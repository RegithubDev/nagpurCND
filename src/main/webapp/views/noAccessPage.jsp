...
.img-fluid-1{
 ...
 <div class="content-body"><div class="auth-wrapper auth-basic px-2">
  <div class=" my-2">
    <!-- verify email basic -->
    <div class="card mb-0 pt-4">
<div class="misc-inner p-2 p-sm-3">
              <div class="w-100 text-center">
                <h2 class="mb-1">Hello ${name }, You are not authorized! for this Activity <i class="fa fa-lock" aria-hidden="true"></i></h2>
               <!--  <p class="mb-2">
                  Your Role was not Authorized for this Activity!
                </p> --><a class="btn btn-primary mb-1 btn-sm-block waves-effect waves-float waves-light" href="<%=request.getContextPath() %>/usermanagement">Back to login</a>
